...
def default():
    hyperparameters = {
        ...
        "depth": 6,
        "mlp_dim": 256,
        "dropout": 0.3, # originally 0.3,
        "emb_dropout": 0.4, # originally 0.4,
        "weight_decay": 0.01, # originally 0.01,
        "drophead": 0, # originally 0.25,
        "layerdrop": 0, # originally 0.25,
        "cutmix": 0.7,
        "mixup": 0.3,
        "alpha": 1,
        "multiplier": 1,
...
def minit_hyperparameters():
    ...
    hyperparameters["cutmix"] = 0# originally 0.36
    hyperparameters["mixup"] = 0 # originally 0.149
    hyperparameters["heads"] = 8  # originally 8
    hyperparameters["dropout"] = 0 # originally 0.07
    hyperparameters["emb_dropout"] = 0 # originally 0.016
    hyperparameters["weight_decay"] = 0 # originally 0.125
    hyperparameters["warmup_epochs"] = 2 # originally 16
